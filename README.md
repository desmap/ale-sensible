...
The first time I installed ALE, I PlugCleaned it right away, the first impression just wasn't good. With ALE's default config, the gutter drives you nuts. It pops in and out when quick-switching between linted and non-linted files. 
