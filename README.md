...
ALE is a modern asynchronous linter for Vim/Neovim (Neovim). ALE SENSIBLE is an opinionated default config offering a welcoming, stutter-free, out-of-the-box experience from the first second you use ALE:
