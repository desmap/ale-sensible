...
ALE SENSIBLE is an opinionated 190-byte-long new default config. It offers a welcoming, stutter-free and out-of-the-box experience from the first second you use ALE:
...
- **No bloat in your .vimrc/init.vim, it's just one line there pulling a 190 byte plugin**
...
...
```
_Above applies to vim-plug users, adjust these lines if you use another or no plugin manager._
