...
- **No bloat in your .vimrc/init.vim, it's just one line pulling a tiny 190-byte-plugin (or add yourself*)**
...
_*Don't want a plugin but just add the stuff yourself to your config? Check this: https://github.com/desmap/ale-sensible/blob/master/plugin/ale-sensible.vim_
