...
ALE is a modern asynchronous linter for Vim/Neovim (Neovim). ALE SENSIBLE are opinionated defaults offering a welcoming, stutter-free, out-of-the-box experience from the first minute you use ALE:
