...
ALE SENSIBLE is an opinionated 190-byte-long default config for the ALE linter fixing ALE's time-consuming default config. It offers a welcoming, stutter-free, turn-key-ready experience:
