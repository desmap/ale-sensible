...
```
...in your .vimrc/init.vim (if you have already any additional `Plug 'w0rp/ale`, remove). Above applies to vim-plug users, adapt this for your plugin manager or just copy'n'paste from [ale-sensible.vim](https://github.com/desmap/ale-sensible/blob/master/plugin/ale-sensible.vim)
